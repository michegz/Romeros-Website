...
const Home: React.FC = () => {
  return (
    <div>
      <Hero
        title={`Full-Service Property Solutions
        `}
        subtitle="SERVING LAFAYETTE AND ACADIANA"

        description="Residential & Commercial Repairs, Maintenance, and Remodeling. One call handles it all."
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-stone-900">
                Residential & Commercial Services in Lafayette & Acadiana
              </h2>
              <p className="mt-4 text-lg text-stone-700 max-w-2xl">
                Romero’s Service Company provides coordinated repairs, maintenance, installations, and remodeling for residential and commercial properties throughout Lafayette, Broussard, Youngsville, Scott, Crowley, Breaux Bridge, Carencro and surrounding Acadiana areas. From plumbing and electrical to carpentry, HVAC, and professional cleaning, we handle property work from start to finish.
