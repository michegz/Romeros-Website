...
const Hero: React.FC<HeroProps> = ({ title, subtitle, description, image, alt, ctaText, ctaLink, isMain, children }) => {
  return (
    <section className="relative min-h-[450px] lg:min-h-[600px] flex items-center overflow-hidden pt-20 bg-stone-100">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full py-12">
        <div className="max-w-2xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-emerald-950 leading-[1.15] mb-6 lg:mb-8">
            {title}
          </h1>
          {/* Enhanced Paragraph: Darker text, medium weight, and better line height */}
          <p className="text-lg md:text-xl font-medium text-stone-700 mb-8 leading-relaxed">
            {description}
          </p>
