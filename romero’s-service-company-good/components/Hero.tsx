  ...
  return (
    <section className={`relative ${isMain ? 'min-h-[85vh]' : 'min-h-[450px] lg:min-h-[600px]'} flex items-center overflow-hidden pt-20 bg-stone-100`}>
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        />
        {/* Modern Gradient Overlay - Fades from solid background on the left to reveal image on the right */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full py-12">
        <div className="max-w-2xl">
          ...
          <p className={`${isMain ? 'text-xl' : 'text-lg'} text-stone-600 mb-8 lg:mb-10 leading-relaxed max-w-lg`}>
            {description}
          </p>
