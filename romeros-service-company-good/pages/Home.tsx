        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-emerald-900/80 mt-4 font-bold">
                A multi-trade company handles plumbing, electrical, and general repairs through a single provider to save you time and money. Romero's specializes in fixing leaks, installing fixtures, and managing property maintenance for homes and businesses in Acadiana.
              </p>
      ...
      <section className="py-32 px-6 bg-white overflow-visible">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            <p className="text-lg text-emerald-900/80 font-bold leading-relaxed">
              Scheduling home repairs in Lafayette is easy with our transparent process that includes a direct point of contact and professional field technicians. We provide licensed and insured service with no money upfront to ensure your property is maintained without the stress of managing multiple vendors.
            </p>
      ...
      <section className="py-24 px-6 bg-stone-50">
        <div className="max-w-5xl mx-auto bg-emerald-900 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg text-emerald-100/90 font-bold mb-10 max-w-3xl mx-auto">
              If you need immediate property repairs in Lafayette or surrounding Acadiana parishes, our team is available 24/7 to provide professional solutions. Contact us today to request emergency service or to schedule a quote for your facility maintenance project.
            </p>
